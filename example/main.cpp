...
int main() {
  ...
  Bicycle norcoAurum;
  norcoAurum.id = 17893448;
  norcoAurum.is_hardtail = false;
  ...
  std::cout << "\n";
  Reflection::print(&norcoAurum);
  std::cout << "\n";

  std::cout << json::Native::to_string(&gtAvalanche).unwrap() << std::endl;
